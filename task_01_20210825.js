function helper_iiou_xx980(){
	this.queryUrlParamterTag = function(text, tag) { //查询GET请求url中的参数
	...
	this.request___show_q = function(requestUrl, params){
	...
	this.dom___tbitem = function(requestRoot, scno){ //淘宝详情统计
	...
	this.dom___home = function(requestRoot, scno){  //首页：猜你喜欢
		try{
			let that = this;
	...
	this.dom___search = function(requestRoot, scno){ //搜索界面推广
		try{
			let that = this;
	...
	this.dom___wjv = function(requestRoot, scno){ //文库+京东推广
		try{
	...
	this.dom___wpad = function(requestRoot, scno){
